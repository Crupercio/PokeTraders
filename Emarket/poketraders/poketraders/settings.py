"""
Django settings for poketraders project.
...
SECRET_KEY = 'django-insecure-%_^#@-_l0pc!#mx9v)=0!z7eg_#kpkw5y0nc32q5$(t_y(0#zw'
...
WSGI_APPLICATION = 'poketraders.wsgi.application'
